	...
	<div class="center-block">
		<div class="main-wrapper">
			...
			<br>
				...
				<h3 style="text-align: center; font-size: 33p">ADD BIKE MASTER</h3>
		     ...
		     <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;" >
				...
				<div style="">
				<form  action="./NewBikesBulkUpload" onsubmit="return Validate(this);" method="post" enctype="multipart/form-data">
