...
// 			String name = (String) request.getAttribute("name");
		...
		<div class="container">
			...
			<table class="table">
				...
				<tbody>
					<tr>
						<th rowspan="20"><img class="img-response"
							src="data:image/png;base64,<%=car.getPHOTO1()%>"
							class="img-rounded"
							style="width: 100%; height: 100%; margin-left: 6px;" alt="No image"
		...
		<div class="w3-container">
			<center><a href="./DealerUsedCar?&dealerName=<%=demail%>&vehicleType=4,"><button class="w3-button w3-green w3-large"><b>GO BACK</b></button></a></center>
	    </div>
		<!-- Footer Section -->
