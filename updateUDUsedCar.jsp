						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive">
								<form action="./updateUsedCarController" name="myform"
									...
									<br> <br>
									<input type="hidden" name="carUpdate" value="UD">
									<div class="row">
									...
									<div class="col-md-3">Registered State</div>
										<div class="col-md-3">
											<div class="form-group">
													 ...
													 <select  name="tstate" class="form-control" id="tstate">
...
var options = "";
options += "<option style='display:none' value="+<%=car.getMODEL_YEAR()%>+">"+ <%=car.getMODEL_YEAR()%> +"</option>";
...
var end = new Date().getFullYear();
var options = "";
options += "<option style='display:none' value="+<%=car.getREGISTERED_YEAR()%>+">"+ <%=car.getREGISTERED_YEAR()%> +"</option>";
for(var year = start ; year <=end; year++){
