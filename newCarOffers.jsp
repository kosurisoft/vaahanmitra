...
<script>
     ...
     function addInput(divName){
          ...
          if (counter == limit)  {
        	  ...
        	  newdiv.innerHTML = '<div class="col-md-12" style="padding: 0 0;"><div class="col-md-3"><input type="text" id="offerName" name="offerName" class="form-control input-sm" id="mobile" placeholder="Enter Offer Name"></div><div class="col-md-3"><input type="text" id="offerPrice" name="offerPrice" class="form-control input-sm" id="mobile" placeholder="Enter Price"></div><div class="col-md-4"><textarea class="form-control input-sm" id="description" name="description" rows="2" placeholder="Enter Your Description" style=" min-height:45px"></textarea></div><div class="col-md-2"></div>';
...
<body>
	<div class="main-wrapper">
      ...
      <form action="./AddNewCarOffer" class="form-horizontal" role="form">
      ...
      <div class="col-md-12 item1">
          ...
          <div class="col-md-12 item1" id="dynamicInput">    
            ...
            <input type="text" id="offerName" name="offerName" class="form-control input-sm" id="mobile" placeholder="Enter Offer Name">
            </div>
            
            <div class="form-group col-md-3 col-sm-6">
            <label>Price :</label>
            <input type="text" id="offerPrice" name="offerPrice" class="form-control input-sm" id="mobile" placeholder="Enter Price">
            </div>
