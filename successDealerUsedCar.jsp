...
<title>Vaahanmitra | UsedCar</title>
...
<body>
	<div class="main-wrapper">
		<div class="app" id="app">
			...
			<div class="row">
				<div align="center">
					<h3 style="">USED VEHICLE DEALER DASHBOARD</h3>
					<br>
				</div>
				<div class="col-md-12">
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							<section class="example well"> <%
 	String str = (String) request.getAttribute("success");
 %> <%=str%>
							<div class="table-responsive">
								<div class="col-md-6">You want to add another Car</div>
								<div class="col-md-6">
									<label> <input class="radio squared"
										name="squared-radios"
										onclick="location.href='dealerUsedCar.jsp'"
										type="radio"> <span>Yes</span>
									</label>
								</div>
								<div class="col-md-6">You want to add Car photos</div>
								<div class="col-md-6 ">
									<label> <input class="radio squared"
										name="squared-radios"
										onclick="location.href='addCarPhotos.jsp'"
										type="radio"> <span>Yes</span>
									</label>
								</div>
								<div class="col-md-6">You want to search Car</div>
								<div class="col-md-6 ">
									<label> <input class="radio squared"
										name="squared-radios"
										onclick="location.href='showDashboard2UsedCarsList.jsp'"
										type="radio"> <span>Yes</span>
									</label>
								</div>
