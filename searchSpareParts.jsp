										...
										<c:forEach var="spss1" items="${spdetails}">
												<tr>
													...
													<%
														...
														if(svt.equals("4,")){
														%>
													<td><a href="./updateSP4.jsp?sku=${spss1.SKU}&vt=${spss1.VEHICLE_TYPE}"><b>UPDATE</b></a></td>
													<% 
														}else{%>
															<td><a href="./updateSP2.jsp?sku=${spss1.SKU}&vt=${spss1.VEHICLE_TYPE}"><b>UPDATE</b></a></td>
													<% 	}
													%>
												<form action="./ActiveInactiveSpareParts" method="post">
								...
								<table>
										<tr>
											...
											<c:forEach begin="1" end="${noOfPages}" var="x">
												<td><a
													href="./SearchSpareParts?page=${x}&vehicleType=<%=vehicleType%>&vehicleBrand=<%=brandid%>&user_name=<%=user_name%>&vehicleModel=<%=carModel%>&sku=<%=sku%>&partName=<%=partName%>">&nbsp;${x}&nbsp;</a></td>
											</c:forEach>
										</tr>
										<%
											}
