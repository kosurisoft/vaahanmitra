...
<body>
							...
							<div class="table-responsive">
								<form action="./updateUsedBikeController" name="myform" method="post"
									...
									<div class="row">
										...
										<div class="col-md-3">
										<input type="hidden" name="bikeUpdate" value="UD">
										...
										<div class="col-md-3">
											<div class="form-group">
												<input type="text" class="form-control " required
													value="<%=bike.getFUELTANK_CAPACITY()%>" onkeyup="NumAndTwoDecimals(event , this);"
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<select name="tstate" required
													class="form-control" id="tstate">
										...
										<div class="col-md-3">
											<select name="tcity" class="form-control"
												required id="tcity">
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<input type="text" name="city" value="<%=bike.getCITY()%>" required
	...
	<script language="javascript">
		 ...
		 <script type= "text/javascript" src = "./assets/js/selectcities.js"></script>
 <script language="javascript">
 populateCity("tstate","tcity"); 
 </script>
	<script>
	var start = 1970;
var end = new Date().getFullYear();
var options = "";
options += "<option style='display:none' value="+<%=bike.getREGISTERED_YEAR()%>+">"+ <%=bike.getREGISTERED_YEAR()%> +"</option>";
