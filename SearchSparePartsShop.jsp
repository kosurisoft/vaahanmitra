	...
	<div class="main-wrapper">
		<div class="app" id="app">
			...
			<div class="row">
					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<section class="col-md-3"
								 style="font-size: 16px; text-align:left;"><strong><u><i>Spare Parts Shop Details</i></u></strong>
							</section>
							<!-- Search ending -->	
								<form action="./SearchBusinessOwners" method="post">
								<section class="col-md-2">
								<input type="hidden" name="k" value="SP">
								<jsp:include page="./BusinessOwnerBCity.jsp">
								<jsp:param name="usertype" value="SP"></jsp:param>
								</jsp:include>
								</section>
								<section class="col-md-2">
						...
						<div class="col-md-12"
							...
							<section class="col-md-3"
								 style="font-size: 14px;"><a href="./AdUpdateBusinessOwner.jsp?k=SC&boid=<%=bo.getSEQUENTIAL_NO()%>"><%=bo.getBUSINESS_NAME()%></a></section>
							<section class="col-md-3"
				...
				<td><a href="./SearchBusinessOwners?bcity=<%=bcity%>&bname=<%=bname%>&vehicletype=<%=vehicletype%>&k=SparePartsShop&page=${i}">${i}</a></td>
			</c:forEach></div>
							</div>
							</div>
							</section>
