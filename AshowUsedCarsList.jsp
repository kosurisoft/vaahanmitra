...
%>
<%@ page language="java" contentType="text/html; charset=ISO-8859-1" import="com.vaahanmitra.dbutil.*, java.sql.Connection.*,java.sql.DriverManager.*,java.sql.*"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									<form action="./showUsedCarListController" method="post">
									<thead>
										<tr>
											<th colspan="21"
...
// 											UsedCar car = new UsedCar();
											...
											try
											{
												...
												String sql = "SELECT * FROM used_car group by CAR_BRAND";
