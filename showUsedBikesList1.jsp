									...
									<div class="col-md-3">
										...
										<div id="txtHint2">
												<select name="city" class="form-control">
													<option value=""><%=(city==null || city=="")?"CITY":city %></option>
												</select>
											</div>
									</div>
							...
							%>
											<c:forEach var="bikeal" items="${success}">
												<tr>
													...
													<td><a href="./updateSCUsedBike.jsp?id=${bikeal.GEN_BIKE_ID}"><b>UPDATE</b></a></td>
												<form action="./InactiveUsedBike" method="post">
												<input type="hidden" name="inactive" value="SC">
										...
										<table>
											<tr>
												...
												<c:forEach begin="1" end="${noOfPages}" var="x">
													<td><a href="./ShowUsedBikeListController?page=${x}&brandid=<%=brandid%>&user_name=<%=user_name%>&bikeModel=<%=bikeModel%>&city=<%=city%>">&nbsp;${x}&nbsp;</a></td>
												</c:forEach>
											</tr>
											<%
									}
