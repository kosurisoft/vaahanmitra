...
<head>
	...
	<jsp:include page="./Admin-right-side.jsp" />
        ...
        <title>Vaahanmitra | Individual Owner Full Details</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                             ...
                             <form name="frm" action="./AddBusinessOwner" method="post" onSubmit="return validate()">
                              ...
                              <div class="col-sm-12"> 
                                 <label for="email"><strong><u><i>Individual Owner Details</i></u></strong></label>
                            					</div>
                              </div>
                              <div class="form-group">
                              <div class="col-sm-12"> 
                              ...
                              <div class="col-sm-6"> 
                                ...
                                <input class="form-control underlined" type="text" value="" name="name" id="name">
                              </div>
                              <div class="col-sm-6"> 
                                 <label for="email">MOBILE</label>
                                 <input class="form-control underlined" type="text" value="" name="mobileNo" id="mobileNo" maxlength="10" onkeypress="CheckNumeric(event)"> 
                              </div>
                              </div>
                           	  <div class="form-group">
                                        <div class="col-sm-6"> 
