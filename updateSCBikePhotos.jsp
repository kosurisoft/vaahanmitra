					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive">
								<form action="./UpdateBikePhotos" enctype="multipart/form-data"
									method="post">
									...
									<br>
									<input type="hidden" name="userType" value="SC">
									<div class="col-md-12">
										<br>
									</div>
									<div class="col-md-3 col-sm-12 col-xs-12" align="center"
										style="margin-bottom: 6px">
										<b>BIKE REGISTRATION NO</b>
									</div>
										...
										<div class="card"
											...
											<div class="card-block">
												<div id="printableArea" style="overflow-x: auto;">
													...
													<div class="col-md-12">
														<div class="col-md-2 col-sm-12 col-xs-12" style="padding: 0 0; margin: 0 16px">
														...
														<div class="col-md-2 col-sm-12 col-xs-12"  style="padding: 0 0; margin: 0 20px">
														...
														<div class="col-md-2 col-xs-12"   style="padding: 0 0; margin: 0 20px">
															<input type="file" name="photo4" accept="image/*"
																onchange="return svalidate('file4')"
																id="file4" placeholder="Select Image">
														</div>
														<div class="col-md-2 col-xs-12"   style="padding: 0 0; margin: 0 10px">
													...
													<div class="col-md-12">
														<div class="col-md-2 col-xs-12" style="padding: 0 0; margin: 0 16px">
														...
														<div class="col-md-2 col-sm-12 col-xs-12" style="padding: 0 0; margin: 0 10px">
