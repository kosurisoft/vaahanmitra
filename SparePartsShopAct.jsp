	...
	<div class="main-wrapper">
		<div class="app" id="app">
			...
			<div class="row">
					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<section class="col-md-4"
								 style="font-size: 16px; text-align:left;"><strong><u><i>Spare Parts Shop</i></u></strong></section>
							<section class="col-md-8" style="font-size: 12px; text-align:right;">
								<form action="./GetBusinessOwners" method="post">
								<section class="col-md-3">
								<input type="hidden" name="k" value="SparePartsShop">
								<jsp:include page="./BusinessOwnerBCity.jsp">
								<jsp:param name="usertype" value="SPAREPARTSSHOP"></jsp:param>
								</jsp:include>
								</section>
								<section class="col-md-3">
								<div id="txtHint">
				...
				<td><a href="./GetBusinessOwners?k=SparePartsShop&page=${i}">${i}</a></td>
			</c:forEach></div>
							</div>
							</section>
						</div>
