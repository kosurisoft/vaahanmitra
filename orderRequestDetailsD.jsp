					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<%-- <form action="./GetOrderRequests" method="post">
        		                ...
        		                <thead class="cf">
        		                <tr>
        		                <td class="numeric" colspan="4">Retailer Order Details</td>
        		                </tr>
        		                </thead>
		        			    <tr class="thre">
		        				<th class="numeric">Order ID</th><th class="numeric"><%=requestId %></th>
		        				<th class="numeric" colspan="2">Retailer Business Name</th><th class="numeric" colspan="2"><%=order1.getBUSINESS_NAME() %></th>
		        				</tr>
		        				<tr>
