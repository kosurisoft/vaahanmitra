				...
				<div class="col-md-12">
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<form action="./Addgst" method="post">
								...
								<%try{	if(request.getAttribute("message")!=null){	out.println(request.getAttribute("message"));}}	catch(Exception e){} %>
							     ...
							     <label for="states">Category :</label>
									...
									<div class="col-md-4">
									 <div class="form-group">
							     <label for="states">GST % :</label>
									<input type="text" id="tbNumbers" value="0" onkeypress="javascript:return isNumber(event)" onchange="calculate(this.value)" maxlength="2" name="gst" class="form-control" placeholder="Enter GST" required>
									</div>
									</div>
