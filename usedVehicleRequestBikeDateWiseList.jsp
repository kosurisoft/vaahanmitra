	...
	<div class="main-wrapper">
		<div class="app" id="app">
			...
			<div class="row">
					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive well">
								<form action="./UsedVehicleSearchBikeByDateController" method="post">
									<div class="col-md-12" style="background-color: #523f6d;">
										<div align="center"
											style="text-align: center;  color: #fff;">
											SEARCH BIKE REQUESTER</div>
											<%
				...
				%>
				<br>
				<div stytle="margin-right: 1080px;"><b>&nbsp;&nbsp;&nbsp;NO OF REQUESTERS :</b>
				<b style="color: #FF9900"><%=count%> </b></div> <br>&nbsp;
				<div class="row">
					<div class="col-md-12">
						<div class="card"
							style="background: #fff; box-shadow: 0px 0px 2px 1px rgba(0, 0, 0, 0.15); border-bottom: 3px solid #a3b745;">
							<div class="card-block" style="border-bottom: 3px solid #a3b745;">
								...
								<div class="table-responsive">
									<form action="./usedVehicleSearchByDateController"
										method="post">
