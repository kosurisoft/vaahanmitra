...
<link href="assets/images/cg1.png" type="icon/img" rel="icon">
    ...
    <body>
        <div class="auth">
                <h4 style="text-align: center; color: #800000">YOUR SUCCESSFULLY REGISTERED PLEASE LOGIN</h4>
                ...
                <div class="card">
                    ...
                    <div class="auth-content">
                        <form id="signup-form" action="./LoginController" method="post" novalidate="">
                            <div class="form-group"> <label class="control-label">EMAIL ADDRESS</label> <input type="text" name="email" class="form-control boxed" placeholder="Enter Username" required> </div>
