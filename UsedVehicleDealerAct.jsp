...
{
	var usertype="USEDVEHICLEDEALER";
if (str=="")
  {
	...
	<div class="main-wrapper">
		<div class="app" id="app">
			...
			<div class="row">
					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<section class="col-md-4"
								 style="font-size: 16px; text-align:left;"><strong><u><i>Used Vehicle Dealers</i></u></strong></section>
							<section class="col-md-8" style="font-size: 12px; text-align:right;">
								<form action="./GetBusinessOwners" method="post">
								<section class="col-md-3">
								<input type="hidden" name="k" value="UsedVehicleDealer">
								<jsp:include page="./BusinessOwnerBCity.jsp">
								<jsp:param name="usertype" value="USEDVEHICLEDEALER"></jsp:param>
								</jsp:include>
								</section>
								<section class="col-md-3">
								<div id="txtHint">
							...
							<section class="col-md-3"  style="padding:3px 0px;font-size: 14px;text-align:center;"><strong>
							STATUS</strong>
							</section>
						</div>
						<%
						...
						<div class="col-md-12"
							...
							<section class="col-md-2"
								 style="font-size: 14px;"><%=bo.getBUSINESS_NAME()%></section>
							<section class="col-md-3"
				...
				<td><a href="./GetBusinessOwners?k=UsedVehicleDealer&page=${i}">${i}</a></td>
			</c:forEach></div>
							</div>
							</section>
						</div>
