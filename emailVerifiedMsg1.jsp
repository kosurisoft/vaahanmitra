                        ...
                        <li><a href="./register.jsp">Registration</a></li>
					 	<%-- <%
							...
							ArrayList<ServiceEndUser> verifiedDetails=(ArrayList<ServiceEndUser>)request.getAttribute("verifiedDetails");
						 	...
						 	session.setAttribute("name", serviceEndUser.getNAME());
							%> 
							
                        	<%if(verifiedEmail!=null){ %>
							<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown" role="button" aria-haspopup="true"><%="Hi "+ serviceEndUser.getNAME()%><span class="caret"></span></a>
							<ul class="dropdown-menu">
			...
			<div class="container">
				<div class="row">
					...
					<!-- <div class="col-lg-6 col-md-6 col-sm-12 col-xsm-12" style="margin-top: 62px;">
						...
						<div class="col-lg-10 col-md-8 col-sm-12 col-xsm-12" style="margin-top: 50px;margin-left: 300px;">
							<div class="auctionFormRight">
							
								<div class="auctionMainForm" style="width: 600px;height: 400px;background-color: #fff;">
								<div style="padding-top: 75px;padding-left: 104px;">
								...
								if(message!=null){
								%>
								<h4><font color="red"><%=message %></font></h4><br>

								<%} else{}%>
								
								<%if(serviceCenter!=null){ %>
								
								<h4><font color="red"><%= serviceCenter%></font></h4>
