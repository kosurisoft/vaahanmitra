					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive">
								...
								%>
								<form action="./BusinessUsedBikeController" name="myform"
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<select class="form-control" required name="color" required>
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<select id="year" class="form-control form-control-sm" name="year" required></select>
											</div>
										</div>
