...
<script>
     ...
     function addInput(divName){
          ...
          if (counter == limit)  {
        	  ...
        	  newdiv.innerHTML = '<div class="col-md-12" style="padding: 0 0;"><div class="col-md-3"> <input type="text" class="form-control input-sm" id="offerName" name="offerName" placeholder="Enter Offer Name"></div><div class="col-md-3"> <input type="text" class="form-control input-sm" id="offerPrice" name="offerPrice" placeholder="Enter Price"></div><div class="col-md-4"><textarea class="form-control input-sm" id="description" name="description" rows="2" placeholder="Enter Your Description" style=" min-height:45px"></textarea></div><div class="col-md-2"></div>';
...
<body>
	<div class="main-wrapper">
      ...
      <form action="./AddNewBikeOffer" class="form-horizontal" role="form">
      ...
      <div class="col-md-12 item1">
           ...
           <label>Variant :	</label>
           		<div id="txtHintR">
					<select name="variant" class="form-control form-control-sm" required>
						<option value="">SELECT MODEL</option>
					</select>
				</div>
            </div>
             ...
             <div class="form-group col-md-3 col-sm-6">
            	<label>Make Year :	</label> 
            		<select name="makeYear" id="makeYear" class="form-control">
						<option>2018</option>
						<option>2017</option>
						<option>2016</option>
						<option>2015</option>
          ...
          <div class="col-md-12 item1" id="dynamicInput">    
            ...
            <input type="text" class="form-control input-sm" id="offerName" name="offerName" placeholder="Enter Offer Name">
            </div>
            
            <div class="form-group col-md-3 col-sm-6">
            <label>Price :</label>
            <input type="text" class="form-control input-sm" id="offerPrice" name="offerPrice" placeholder="Enter Price">
            </div>
            
              <div class="form-group col-md-4 col-sm-6">
             <label>Description :</label>
            <textarea class="form-control input-sm" id="description" name="description" rows="2" placeholder="Enter Your Description" style=" min-height:45px"></textarea>
            </div>
       ...
       <!--   <div class="col-md-12 item1">    
            ...
            <label>Description :</label>
            <textarea class="form-control input-sm" id="description" name="description" rows="4" placeholder="Enter Your Description" style=" min-height:65px"></textarea>
            </div>
