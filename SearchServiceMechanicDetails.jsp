	...
	<div class="main-wrapper">
		<div class="app" id="app">
			...
			<div class="row">
					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<section class="col-md-3"
								 style="font-size: 16px; text-align:left;"><strong><u><i>Service Centers</i></u></strong>
							</section>
								<form action="./SearchBusinessOwners" method="post">
								<section class="col-md-2">
								<input type="hidden" name="k" value="SC">
								<jsp:include page="./BusinessOwnerBCity.jsp">
								<jsp:param name="usertype" value="SC"></jsp:param>
								</jsp:include>
								</section>
								<section class="col-md-2">
				...
				<td><a href="./SearchBusinessOwners?k=ServiceMechanic&page=${i}">${i}</a></td>
			</c:forEach></div>
							</div>
							</section>
						</div>
