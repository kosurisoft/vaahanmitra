...
<script type="text/javascript">
    function formSubmit()
    {
      ...
      var x=document.forms["signup_form"]["bName"].value.replace(/^\s+|\s+$/g, '')
      var y=document.forms["signup_form"]["name"].value.replace(/^\s+|\s+$/g, '')
      if (x == "" || y=="")
      {
      alert("Space not allowed! Please fill the field...");
      return false;
      }
      return true;
    }
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="">
									...
									%>
										...
										%>
								<form action="./UpdateSpProfile" name="signup_form"
									...
									<div class="row">
										...
										<div class="col-md-3" align="left">
											<input type="hidden" name="pancard" class="form-control "
												id="panNo" value="<%=bor.getPANCARD_NO()%>"></input>
											<%if(bor.getPANCARD_NO().equals("M")){ %>
											<input type="text" class="form-control "
												id="panNo" value="Distributor" readonly="readonly"></input>
											<%}else if(bor.getPANCARD_NO().equals("D")){ %>
											<input type="text" class="form-control "
												id="panNo" value="Distributor" readonly="readonly"></input>
											<%}else if(bor.getPANCARD_NO().equals("R")){ %>
											<input type="text" class="form-control "
												id="panNo" value="Retailer" readonly="readonly"></input>
											
											<%}%>
											
											<%-- <input type="text" name="pancard" class="form-control "
												id="panNo" value="<%=bor.getPANCARD_NO()%>" required></input> --%>
...
<!-- 												onkeypress="return checkSpcialChar(event)" -->
										...
										<div class="col-md-3">
											<input type="text" class="form-control " value="<%=bor.getGSTNO()%>" readonly="readonly">
										</div>
										...
										<div class="col-md-12 col-sm-12 col-xs-12" align="center">
											<button TYPE="submit" onclick="return(formSubmit())"
