					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive well">
								<form action="./UsedVehicleGetRequesterController" method="post">
								...
								<div class="table-responsive">
									...
									<div id="printableArea">
										<table class="table table-striped table-bordered table-hover">
											...
											<tr>
												<td colspan="5" align="right"><a href="javascript:void(0);" class="btn btn-primary" onclick="printPageArea('printableArea')"> Print Page</a></td>
												</tr>
										</table></div>
									</form>
								</div>
