...
ArrayList<SpareParts> spbrand = spdetails.getSpBrand(spBrand,user_name);
Iterator it=spbrand.iterator();
%>
<select name="vehicleBrand" class="form-control" id="vehicleBrand" onchange="getSpModel(this.value)" required>
