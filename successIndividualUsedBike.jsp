						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<tr>
											<td>YOU WANT TO ADD ANOTHER USED BIKE</td>
											<td>
												<div class="form-group">
													<div>
														<label> <input class="radio squared"
															name="squared-radios"
															onclick="location.href='individualUsedBike.jsp'"
															type="radio"> <span>Yes</span>
														</label> <label> <input class="radio squared"
															name="squared-radios" type="radio"> <span>No</span>
														</label>
													</div>
												</div>
											</td>
