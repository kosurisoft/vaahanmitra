...
ArrayList<BusinessOwnerRegister> bor1 = bos.getSparepartsDealers(Brand, city, v_type);
...
%>
    ...
    <tr><td colspan="6" style=" text-align: center;
       padding: 10px 0;font-size: 14px;">Spare Part Dealers not available! at <%=city%> </td></tr>
   <%} %>
   		 	<% while(al.hasNext()){
