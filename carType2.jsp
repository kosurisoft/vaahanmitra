...
<script>
	function displayCarModels(str) {
		if (str == "") {
			document.getElementById("carModelBlock").innerHTML = "";
			return;
		}
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				document.getElementById("carModelBlock").innerHTML = xmlhttp.responseText;
			}
		}
		xmlhttp.open("GET", "./carModels.jsp?carBrand=" + str, true);
		xmlhttp.send();
	}
</script>
</head>
								...
								<div class="card-block"
									...
									<section class="example">
										<div class="table-responsive">
											<form name="form1" action="./VehicleTypeController"
												...
												<table
													...
													<tbody>
														<tr>
															<td>Choose Vehicle Type</td>
															<td>
																<div class="form-group">
																	<label><input type="radio" name="vehicleType"
																		value="FOUR" onclick="location.href='carType2.jsp'"
																		checked> FOUR WHEELER </input></label> <label><input
																		type="radio" name="vehicleType" value="TWO"
																		onclick="location.href='bikeType2.jsp'"> TWO
																		WHEELER </input></label>
																</div>
															</td>
														</tr>
														<tr>
															<td>Car Brand</td>
															<td><jsp:include page="./getCarBrand1.jsp" /></td>
														</tr>
														<tr>
															<td colspan="2">
																<div id="carModelBlock"></div>
															</td>
														</tr>
														<tr>
