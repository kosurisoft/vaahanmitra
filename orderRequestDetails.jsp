					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<%-- <form action="./GetOrderRequests" method="post">
        		                ...
        		                <thead class="cf">
        		                <tr class="thre">
        		                <th class="numeric" colspan="5">Order Header Details</th>
        		                </tr>
        		                </thead>
		        			    <tr class="thre">
		        				<th class="numeric">Order ID</th><th class="numeric"><%=requestId %></th>
		        				<th class="numeric" colspan="2">Distributor</th><th class="numeric" colspan="2"><%=order1.getBUSINESS_NAME() %></th>
		        				</tr>
		        				<tr>
        		                ...
        		                <thead class="cf">
        		                <tr class="thre">
        		                <th class="numeric" colspan="8">Order Details</th>
        		                </tr>
        		                </thead>
		        			    <tr class="thre">
