...
<head>
    ...
    <body>
        ...
        <div id="page-content">
            ...
            <!-- tour details -->
            <section class="tour-details-inner" style="margin-top: 22px;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                           <% 
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                ...
                                                <a href="#"><img src="data:image/png;base64,${carDetails.PHOTO}" alt="No image" class="img-responsive"></a>
                                            </div>
                                            <div class="grid-content">
                                                <div class="grid-price text-right">
                                                    Only <span><sub>$</sub><c:out value="${carDetails.OFFER_PRICE}"></c:out></span>
                                                </div>
                                                
                                            </div>
                                        </div>
                                    <div class="col-lg-12" style="background: #efefef;">
                                        <h2><c:out value="${carDetails.CAR_BRAND}"></c:out></h2>
                                        <p><c:out value="${carDetails.FUEL_TYPE}"></c:out></p>
                                        <p><c:out value="${carDetails.COLOR}"></c:out></p>
                                    </div>
                                    </div>
                                    </c:forEach>
                        <div class="col-md-4 col-sm-6 col-xs-12 grid-item">
