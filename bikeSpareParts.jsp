				...
				<div class="col-md-12">
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table" style="border-radius:4%">
								<form action="./AddSpareParts" method="POST"
									...
									<label><input type="radio" name="vehicleType" value="individual" onclick="location.href='spareParts.jsp'"><b> FOUR WHEELER
									</b></label>					
									</div>
									<div class="col-md-5" align="center">
								   ...
								   <div class="row">
								     ...
								     <label for="states">Bike Brand :</label>
	                                 ...
	                                 <div class="col-md-4">
	                                 <div class="form-group">
								     <label for="states">Bike Model :</label>
								     <div id="txtHint1">
	                               ...
	                               <div class="row">
									 <div class="col-md-4">
	                                 <div class="form-group">
								     <label for="states">Manufacture Company Name :</label>
								     ...
								     <input type="text" name="partNo" class="form-control" placeholder="Enter PartNo" required>
	                                 </div>
	                                 </div>
								     ...
								     <input type="text" class="form-control" name="bsku" id="sku" placeholder="Enter SKU" required>
	                                 </div>
	                                 </div>
	                               </div>
	                               ...
	                               <div class="row">
								     ...
								     <div class="" id="subcat">
								     <input type="text" name="subcategory" class="form-control" placeholder="Enter Sub Category">
	                                 </div>
	                                 </div>
	                                 </div>
	                               </div>
	                               ...
	                               <div class="row">
	                                 ...
	                                 <label style="color:#fff;">Speciagfghgu</label>
									 <input type='button' value='Add Specifications' class="btn btn-primary" id='addButton'>
	                                 </div>
	                                
	                                 <div class="col-md-3" style="padding:0 0px;">
	                                 <label for="states" style="color:#fff;">Sbbbggmhgngh :</label>
	                                 <input type='button' class="btn btn-primary" value='Remove Specifications' id='removeButton'>
	                                 </div>
								   ...
								   <div class="row">
								     ...
								     <label for="states"><%if(bType.equals("M")){ %>
										...
										<%}%>
										Final Price :</label>
								     <input name="finalprice" class="form-control"
													onkeyup="NumAndTwoDecimals(event , this);" type="text"	id="finalprice" placeholder="Enter Price" maxlength="20">
	                                 </div>
	                                 </div>
								 ...
								 <div class="row">
	                                 ...
	                                 <div class="form-group">
								     <label for="states" style="color:#fff;">dgd:</label><br>
								     <span>%</span>
	                                 </div>
	                                 </div>
	                                 ...
	                                 <div class="col-md-1 col-xs-3" style="padding:0 0px;">
	                                 <div class="form-group">
								     <label for="states" style="color:#fff;">jytj:</label><br>
								     <span>%</span>
	                                 </div>
	                                 </div>
