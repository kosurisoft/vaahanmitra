					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="col-md-12 row" >
								...
								<div class="col-md-12">
								<h5 align="center" style="background:#7a98b1;color:#fff">SEARCH SERVICE CENTER</h5></div><br><br>
...
<!-- 								<select name="state" class="form-control states order-alpha underlined" id="stateId"> -->
					...
					<%}%><br>
						...
						<div class="col-md-12"
							...
							<section class="col-md-2" style="font-size: 14px;"><u><a href="./emUpdateBSOwner.jsp?k=SC&boid=<%=bo.getSEQUENTIAL_NO()%>"><%=bo.getNAME()%></a></u></section>
