    ...
    %>
            ...
            <section class="service-inner" style="background-color: #efefef;">
              ...
              <form action="./SearchHMechanic" method="post">
                ...
                <div class="col-md-2 col-sm-6 col-xsm-12" style="margin-top: 15px;">
...
<br>
                ...
                while(itr.hasNext()){
                    ...
                    <%-- <section class="col-lg-12 col-md-12 col-sm-12 col-xsm-12" style="background: #ffffff;box-shadow: 0px 0px 2px 1px rgba(0,0,0,0.15);border-radius: 5px;margin-top: 5px;margin-bottom: 0px;padding-bottom:11px;margin-left: -76px;">
                       
                        <div class="col-md-8">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xsm-12" style="margin-top: 18px;font-size: 12px;margin-bottom: 5px;"><span style="font-weight:600;color:#000;font-size:15px;"><%=bean1.getBUSINESS_NAME() %></span>
                        <%
                        String suser=bean1.getEMAIL_ID();
                        float rate=mdetails.getRate(suser);
                        %>
                        <span>&nbsp;&nbsp;<font color="red"><b>Rating:</b></font></span>&nbsp;&nbsp; 
                        <span class="stars" style="float: right;margin-right: 336px;"><%=rate %></span>
                        
                       <b> <%=rate %></b>
                       
<span id="myspan"><%=rate %></span>
                      ...
                      <%if(vehicleType1.equals("SELECT")){ %>
                         <div class="col-lg-12 col-md-12 col-sm-12 col-xsm-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;"><span style="color:#f94141;font-weight:600;font-size:15px;">SERVICE FOR:</span>&nbsp;&nbsp;<span style="font-weight:600;color:#000;font-size:13px;"><%=(bean1.getVEHICLE_TYPE().equals("2,"))?"TWO WHEELER":(bean1.getVEHICLE_TYPE().equals("4,"))?"FOUR WHEELER":(bean1.getVEHICLE_TYPE().equals("4,2,"))?"TWO WHEELER & FOUR WHEELER":"N/A"%>&nbsp;&nbsp;<font color="red">BRAND:</font>&nbsp;&nbsp;<%=bean2.getVEHICLE_BRAND()==null?"N/A":bean2.getVEHICLE_BRAND() %></span></div>
                      ...
                      <%} %>
                     	<div class="col-lg-12 col-md-12 col-sm-12 col-xsm-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;"><span style="color:#f94141;font-weight:600;font-size:15px;">ADDRESS:</span>&nbsp;&nbsp;<span style="font-weight:600;color:#000;font-size:13px;"><%=bean1.getADDRESS()+","+bean1.getLOCATION() %></span></div>
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xsm-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;"><span style="color:#f94141;font-weight:600;font-size:15px;">CITY:</span>&nbsp;&nbsp;<span style="font-weight:600;color:#000;font-size:13px;"><%=bean1.getB_CITY() %></span></div>
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xsm-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;"><span style="color:#f94141;font-weight:600;font-size:15px;">STATE:</span>&nbsp;&nbsp;<span style="font-weight:600;color:#000;font-size:13px;"><%=bean1.getSTATE() %></span></div>
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xsm-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;"><span style="color:#f94141;font-weight:600;font-size:15px;">VERIFIED:</span>&nbsp;&nbsp;<span style="font-weight:600;color:#000;font-size:13px;"><%=bean1.getVERIFIED() %></span></div>
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xsm-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;"><span style="color:#f94141;font-weight:600;font-size:15px;">Email Address:</span>&nbsp;&nbsp;<span style="font-weight:600;color:#000;font-size:13px;"><%=bean1.getEMAIL_ID() %></span></div>
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xsm-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;"><span style="color:#f94141;font-weight:600;font-size:15px;">Phone Number:</span>&nbsp;&nbsp;<span style="font-weight:600;color:#000;font-size:13px;"><%=bean1.getOFFICE_PHONE_NO() %></span></div>
                       	
              		  
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xsm-12" style="margin-top: 10px;font-size: 12px;margin-bottom: 5px;"><a id="toggle<%=i %>" href="javascript:toggle_it('<%="toggleText"+i %>','toggle<%=i %>')"  style="padding:0px;font-size:20px;">+</a>&nbsp;&nbsp;<span style="color:#f94141;font-weight:600;font-size:15px;">SERVICE TYPE:</span>&nbsp;&nbsp;</div>
 ...
 <button onclick="document.getElementById('idr<%=j %>').style.display='block'" class="w3-button w3-green w3-large" style="float:right;margin-top:-43px;margin-right: 253px;">Rate</button>
  ...
  <div id="idr<%=j %>" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:260px">
      ...
      <input type="hidden" name="vehicleType" value="<%=(vehicleType1.equals("TWO WHEELER"))?"2,":(vehicleType1.equals("FOUR WHEELER"))?"4,":(vehicleType1.equals("TWO WHEELER & FOUR WHEELER"))?"4,2,":"SELECT"%>"/>
...
<!-- <div id="register" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:30%">
      ...
      <div class="w3-center"><br>
        ...
        <h4 class="w3-button w3-xlarge w3-hover-red">User Login</h4>
      </div>
        <div class="w3-section">
        <div id="txtHint"></div>
        <form action="./LoginController" method="post">
           <label><b style="margin-left: 13px;">Email</b></label>
          <input class="w3-input w3-border w3-margin-bottom" name="email" style="width: 450px;
      margin-left: 13px;" type="text" placeholder="Email" name="email" required>
          <label><b style="margin-left: 13px;">Password</b></label>
          <input class="w3-input w3-border" style="width: 450px;
      margin-left: 13px;" type="password" placeholder="Password" name="password"  required>
          <button class="w3-button w3-block w3-green w3-section w3-padding" style="width: 450px;
      margin-left: 13px;" type="submit">Submit</button>
    </form>
        </div>
      <div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
      ...
      <button onclick="document.getElementById('id01').style.display='none'" type="button" class="w3-button w3-red">Go Back</button>
             			...
             			<a href="#" style="cursor: pointer;"><img src="data:image/png;base64,<%=bean1.getPHOTO() %>" alt="No image" class="img-responsive" style="margin-top: 20px;border-radius: 5px;height: 200px;width: 274px;margin-left: 80px;font-size: 25px; font-family: sans-serif; background: #fff;text-align: center;margin-bottom: 3px;"></a>
             			<%}else{ %>
             			
             			 <a href="#" style="cursor: pointer;"><img src="./images/ServiceImage.png" alt="No image" class="img-responsive" style="margin-top: 20px;border-radius: 5px;height: 200px;width: 274px;margin-left: 80px;font-size: 25px; font-family: sans-serif; background: #fff;text-align: center;margin-bottom: 3px;"></a>
...
<div class="col-md-10 col-sm-12 col-xs-12  well" style="background-color: #fff;box-shadow: 0px 0px 2px 1px rgba(0,0,0,0.15); border-radius: 4px; margin-bottom: 7px; position: relative; right: 17px;margin-top: 0px;">
	...
	<aside class="col-md-8">
		...
		<%if(vehicleType1!=null && vehicleType1.equals("SELECT")){ %>
		<div class="row">
        ...
        <div class="col-md-9 col-sm-6 col-xs-12"><span style="color:#000;text-transform: lowercase;"><%=(bean1.getVEHICLE_TYPE().equals("2,"))?"TWO WHEELER":(bean1.getVEHICLE_TYPE().equals("4,"))?"FOUR WHEELER":(bean1.getVEHICLE_TYPE().equals("4,2,"))?"TWO WHEELER & FOUR WHEELER":"N/A"%></span></div>
		...
		<div class="col-md-12 col-xs-12 col-sm-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;">
		<div class="col-md-3 col-sm-6 col-xs-12"><span style="color:#555;font-weight: 600;">Vehicle Type:</span></div>
        <div class="col-md-9 col-sm-6 col-xs-12"><span style="color:#000;text-transform: lowercase;"><%=(bean1.getVEHICLE_TYPE().equals("2,"))?"TWO WHEELER":(bean1.getVEHICLE_TYPE().equals("4,"))?"FOUR WHEELER":(bean1.getVEHICLE_TYPE().equals(vehicleType1))?"TWO WHEELER & FOUR WHEELER":vehicleType1 %></span></div>
        ...
        <div class="col-md-9 col-sm-6 col-xs-12"><span style="color:#000;text-transform: lowercase;"><%=bean2.getVEHICLE_BRAND()==null?"N/A":bean2.getVEHICLE_BRAND() %></span></div>
		  ...
		  <div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;">
             ...
             <div class="col-md-9 col-sm-6 col-sm-6"><span style="color:#000;text-transform: lowercase;"><%=bean1.getADDRESS()+","+bean1.getLOCATION() %></span>
           </div>
   ...
   <div class="row">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12"><span style="color:#555;font-weight: 600;">City:</span></div>
      <div class="col-md-9 col-sm-6 col-xs-12"><span style="color:#000;text-transform: lowercase;"><%=bean1.getB_CITY() %></span></div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;">
     <div class="col-md-3 col-sm-6 col-xs-12"><span style="color:#555;font-weight: 600;">State:</span></div>
      <div class="col-md-9 col-sm-6 col-xs-12"><span style="color:#000;text-transform: lowercase;"><%=bean1.getSTATE() %></span></div>
          ...
          <div class="col-md-9 col-xs-12 col-sm-6"><span style="color:#3c763d;text-transform: lowercase;"><b><%=bean1.getVERIFIED() %></b></span></div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;">
     ...
     <div class="col-md-9 col-sm-6 col-xs-12"><span style="color:#000;text-transform: lowercase;"><%=bean1.getEMAIL_ID() %></span></div>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 0px;font-size: 12px;margin-bottom: 5px;">
     ...
     <div class="col-md-9 col-sm-6 col-xs-12"><span style="color:#000;"><%=bean1.getOFFICE_PHONE_NO()==null?"N/A":bean1.getOFFICE_PHONE_NO()+" , "%><%=bean1.getMOBILE_NO()==null?"N/A":bean1.getMOBILE_NO().equals("NA")?"":bean1.getMOBILE_NO()%></span></div>
...
//                         String retval: str.split(",")
					...
					<%} %>
					 ...
					 <br>
 				       <span style="color:red;font-size:15px;text-align: justify;">Service Type is not available if it is your service center please <a href="./register.jsp"><font color="blue" font-size="3">register</font></a> here and update your contact details</span>
 				       </div>
 				       <%} %>
             ...
             <br>
             <div class="col-md-12" style="border-top: 1px solid #f1f2f3;">
             <br>
             <div class="col-md-12 col-xs-12" align="right">
             <button onclick="document.getElementById('id0<%=i %>').style.display='none'" type="button" class="w3-button w3-red">
             Cancel
             </button>
             </div>
...
<%--        <font color="red" size="4" face="Times New Roman">if you are existing user <a href="#" onClick="document.getElementById('id0<%=i %>').style.display='none',document.getElementById('register').style.display='block'">Login Here</a></font><br>
	...
	<%=(bean1.getVEHICLE_TYPE().equals("2,"))?"TWO WHEELER":(bean1.getVEHICLE_TYPE().equals("4,"))?"FOUR WHEELER":(bean1.getVEHICLE_TYPE().equals("4,2,"))?"TWO WHEELER & FOUR WHEELER":"N/A"%> --%>
      ...
      <div class="col-md-12 col-xs-12" align="center">
       <font color="660033" size="4" face="Times New Roman"><%=bean1.getBUSINESS_NAME() %></font>
      </div>
      <br><br>
     ...
     %>
        ...
        <div class="w3-section">
           <label>Vehicle Type</label>
        <select class="form-control" name="vehicleType1" id="vehicleType" class="w3-input w3-border w3-margin-bottom" required>
        ...
        <label>Vehicle Brand</label>
        <select class="form-control" name="evehicleBrand" id="vehicleBrand" class="w3-input w3-border w3-margin-bottom" onchange="showServiceModal(this.value,emailId<%=i%>)">
        ...
        %>
         ...
         <div id="txtHint"><label>Vehicle Modal</label>
        <select class="form-control" name="model" id="model" class="w3-input w3-border w3-margin-bottom">
        <option  value="<%=endUser==null?" ":endUser.getMODEL()==null?" ":endUser.getMODEL() %>" style="display:none;"><%=endUser==null?"Vehicle Model":endUser.getMODEL()==null?"Vehicle Model":endUser.getMODEL() %></option>
          ...
          <label>Name</label>
          <input class="w3-input w3-border w3-margin-bottom form-control" type="text" placeholder="Username" value="<%=endUser==null?"":endUser.getNAME()==null?"User Name":endUser.getNAME() %>" name="name"  required>
         <%if(verifiedEmail!=null){ %>
          <%} else{%>
          <label>Email</label>
          <input class="w3-input w3-border form-control" type="email" placeholder="Email" name="email" value="<%=endUser==null?"":endUser.getEMAIL()==null?"Email":endUser.getEMAIL() %>" required>
           <%} %>
           <label>Mobile No</label>
          <input class="w3-input w3-border form-control" type="text" placeholder="Mobile No" name="mobileNo" value="<%=endUser==null?"":endUser.getMOBILE_NO()==null?"Mobile Number":endUser.getMOBILE_NO() %>" pattern="[1-9]{1}[0-9]{9}" title="Enter 10 digit mobile number" required maxlength="10">
          <label>Vehicle No</label>
          <input class="w3-input w3-border form-control" type="text" placeholder="Vehicle No" name="carNo" value="<%=endUser==null?"":endUser.getCAR_NO()==null?"Vehicle Number":endUser.getCAR_NO() %>" required>
           <label><b>Date Of Appointment</b></label>
          <input class="w3-input w3-border form-control" type="date"  placeholder="Date" name="date" value="<%=endUser==null?"":endUser.getAPPOINTMENT_DATE()==null?"Date":endUser.getAPPOINTMENT_DATE() %>" min="<%=ft.format(dNow)%>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Select date';}" required>
           
            <%if(verifiedEmail!=null){ %>
          <%} else{%>
          
          <label>Password</label>
          <input class="w3-input w3-border form-control" type="password"  placeholder="Password" name="psw" required>
          <%} %>
          <div class="col-md-12 col-xs-12" style="padding-bottom: 10px;    margin-top: 19px;" >
          
          <button class="w3-button w3-block w3-green w3-section w3-padding form-control" type="submit">
          Submit
          </button>
...
<%}else{} %>
	...
	<aside class="col-md-4 col-sm-12 col-xs-12" align="right">
       ...
       <%i++;j++;}%>
             	<section class="col-lg-10 col-md-10 col-sm-10 col-xsm-10" style="margin-left: 0px;background-color: #fff;margin-top: 0px;box-shadow: 0px 0px 2px 1px rgba(0,0,0,0.15);border-radius: 5px;">
             			Pages:&nbsp;
                 	<c:forEach begin="1" end="${noOfPages}" var="k">
				
<%-- 				<td style="float: left" ><a href="./SearchHMechanic?page=${k}&city=<%=city1%>&vehicleType=<%=vehicleType1%>&vehicleBrand=<%=vehicleBrand1%>">${k}&nbsp;&nbsp; </a></td> --%>
					...
					<c:set var="currentPage" value="${currentPage}"></c:set>
             			...
             			%>
				<a href="./SearchHMechanic?page=${k}&city=<%=city1%>&vehicleType=<%=vehicleType1%>&vehicleBrand=<%=vehicleBrand1%>" style="color:#fc6116;"><u>${k}&nbsp;</u></a>
             			<%} else{%>
             			
				<a href="./SearchHMechanic?page=${k}&city=<%=city1%>&vehicleType=<%=vehicleType1%>&vehicleBrand=<%=vehicleBrand1%>">${k}&nbsp;</a>
 				<%} %>
			
			</c:forEach>
			</section>
        <%}else{%>
        <section class="col-lg-10 col-md-10 col-sm-10 col-xsm-10" style="height:200px;background: #f5f5f5;border-radius: 5px;margin-top: 0px;margin-bottom: 10px;">
                      <div class="col-lg-10 col-md-10 col-sm-10 col-xsm-10" style="margin-top: 10px;font-size: 18px;margin-bottom: 5px;"><span style="font-weight:600;color:red">Data not found.....</span></div>
                    </section>
