	...
	<div class="main-wrapper">
		<div class="app" id="app">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card"
						...
						<div class="col-md-12"
							...
							<section class="col-md-3"
								 style="font-size: 14px;"><a href="./AdUpdateBusinessOwner.jsp?k=SP&boid=<%=bo.getSEQUENTIAL_NO()%>"><%=bo.getBUSINESS_NAME()%></a></section>
							<section class="col-md-3"
				...
				<td><a href="./GetServiceMechanics?k=SP&page=${i}">${i}</a></td>
			</c:forEach></div>
							</div>
							</div>
							</section>
