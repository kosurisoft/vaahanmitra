                        ...
                        <div class="row">
                            <div class="col-md-12">
                             ...
                             <form name="frm" action="./AddBusinessOwner" method="post" onSubmit="return validate()">
                              ...
                              <div class="col-sm-12"> 
                                 <label for="email"><strong><u><i>Spare Parts Shop Add</i></u></strong></label>
                            					</div>
                              </div>
                              <div class="form-group">
                              <div class="col-sm-12"> 
                              ...
                              <div class="col-sm-12"> 
                                 ...
                                 <input type="hidden" name="usertype" value="SPAREPARTSSHOP">
                                 <input type="text" class="form-control underlined" name="businessName" required placeholder="Enter Business Name">
                                 </div>
                              </div>
                           	  <div class="form-group">
                                        <div class="col-sm-6"> 
                                        <label for="password">BUSINESS TYPE</label>
                                            <select class="form-control underlined" name="businesstype">
                               ...
                               <div class="form-group"> 
                                 ...
                                 <input class="form-control underlined" type="text" placeholder="Enter EmailId" name="location" id="location" required> 
                              </div> -->
                              <div class="col-sm-6"> 
                                 <label for="email">GSTIN</label>
                                 <input class="form-control underlined" type="text" required placeholder="Enter GSTIN No." name="gstin"> 
                              </div>
                              </div>
