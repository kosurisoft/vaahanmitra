					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive">
								<form action="./SearchIndividualUsedBikeController"
									method="GET">
							...
							%>
											<c:forEach var="bikeal" items="${success}">
												<tr>
													...
													<td><a href="./updateUsedBike.jsp?id=${bikeal.GEN_BIKE_ID}"><b>UPDATE</b></a></td>
											<form action="./InactiveUsedBike" method="post">
												...
												<input type="submit" style="background-color: #a3b745;border-radius: 10px" value="${caral.STATUS}">
													...
													<%-- 													<td><a href="./updateUsedBike.jsp?id=${bikeal.BIKE_NUMBER}"><b>UPDATE</b></a></td> --%>
													<%-- <td><div id="<%="yesnos" + i%>">
															<c:out value="${bikeal.STATUS}"></c:out>
														</div></td>
													<td><input type="checkbox" name="vehicle"
														id="<%="smoking"+j %>" value="${bikeal.BIKE_NUMBER}"
														onclick="yesno('<%="smoking"+j %>','<%="yesnos"+i %>');" />
														</div></td> --%>
												</tr>
												<%
													i++;
										...
										<table>
											<tr>
												...
												<c:forEach begin="1" end="${noOfPages}" var="x">
													<td><a href="./SearchIndividualUsedBikeController?page=${x}&brandid=<%=brandid%>&user_name=<%=user_name%>&bikeModel=<%=bikeModel%>&city=<%=city%>">&nbsp;${x}&nbsp;</a></td>
												</c:forEach>
											</tr>
											<%
									}
