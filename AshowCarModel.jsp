                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                 <form action="">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="2" style="text-align: center;background-color: #523f6d;color: #fff;">CAR MODELS</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <td>Car Brand</td>
                                                            <td>
                                                                <div class="form-group"> <select required id="brand" name="model" class="form-control form-control-sm">
                                                        ...
                                                        <tr>
                                                            <td>Car Model</td>
                                                            <td>
                                                                <div class="form-group"> <select required id="model" name="model" class="form-control form-control-sm">
                                                        ...
                                                        <tr>
                                                         ...
                                                         <button style="background-color: #a3b745;border: 1px solid #a3b745;"  class="btn btn-primary">SEARCH</button>   
                                                         </td>
                                                        </tr>
                                                    </tbody>
                                                    </form>
