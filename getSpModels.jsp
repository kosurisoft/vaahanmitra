...
ArrayList<SpareParts> carModel = sp.getSpModel(brand, user_name);
Iterator it= carModel.iterator();
%>
<select name="vehicleModel" class="form-control" id="vehicleModel" onchange="getSPCategory(this.value)">
