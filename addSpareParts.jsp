							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<thead>
										<tr>
											<th colspan="2"
												style="text-align: center; background-color: #523f6d; color: #fff;">SPARE
												PARTS</th>
										</tr>
									</thead>
									<tbody>
											...
											<td>
												<div class="form-group">
													<select class="form-control form-control-sm" required>
														...
														<option value="mechanicParts">Mechanic Parts</option>
													</select>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class="form-group">
													<input type="text" class="form-control boxed" required>
												</div>
											</td>
										</tr>
										<tr>
											<td>Spare Part Brand</td>
											<td>
												<div class="form-group">
													<input type="text" class="form-control boxed" required>
												</div>
