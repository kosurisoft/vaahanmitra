          ...
          <h2>Get Buyers&rsquo; Details via SMS and Email</h2>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xsm-12">
							<div class="auctionFormRight">
								<center><h5 STYLE="color:red"><b>EMAIL-ID OR PASSWORD INCORRECT PLEASE ENTER CORRECT </b></h5></center>
								<div class="auctionMainForm">
									<h2 class="aucformTitle"><center>USER LOGIN</center></h2>
									...
									<form name="sellfrm" id="sellfrm"
										...
										<div class="aucformFieldsBox">
											<label>PASSWORD<span>*</span></label> <input type="password" style="position: relative; left: 56px; width: 235px;padding-bottom: 6px;"
												name="password" required>
										</div>
										
										<div class="aucformFieldsBox" style="padding:10px 0px;">
