								...
								<table class="table table-striped table-bordered table-hover">
									...
									<c:forEach var="caral" items="${success}">
										<tr>
											...
											<td><a href="./updateSCUsedCar.jsp?id=${caral.GEN_CAR_ID}"><b>UPDATE</b></a></td>
								...
								<table>
									<tr>
										...
										<c:forEach begin="1" end="${noOfPages}" var="x">
											<td><a
													href="./ShowUsedCarListController?page=${x}&brandid=<%=brandid%>&user_name=<%=user_name%>&carModel=<%=carModel%>&city=<%=city%>">&nbsp;${x}&nbsp;</a></td>
											</c:forEach>
									</tr>
									<%
										}
