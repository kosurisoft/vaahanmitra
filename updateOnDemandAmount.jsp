					...
					<div class="card" style="background: #fff; box-shadow: 0px 0px 2px 1px rgba(0,0,0,0.15);border-bottom: 3px solid #a3b745;">
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive">
									<form action="./UpdateOnDemandAmount" method="post">
								...
								OnDemandDriverRoutes driverSal=hm.getOnDemandAmount(userId);

								String message=(String)request.getAttribute("message1");
								%>
									
									
										<div class="col-md-12" style="background:#052963;color: #fff;text-align: center;font-weight: bolder;height:44px;margin-top:8px;padding: 10px;">Expected Amount</div>
										...
										%>
										           ...
										           <label for="exampleInputEmail1">Expected Charges(per hour)</label>
										           ...
										           <div class="col-md-3 col-xs-12 col-sm-12" align="left">
													...
													<%if(driverSal!=null){ %>
													<input type="text" name="expCharges" value="<%=driverSal.getEXPECTED_CHARGES() %>" class="form-control input-sm" required onkeypress="CheckNumeric(event)"/>
										           ...
										           <div class="col-md-3 col-xs-12 col-sm-12" align="left">
													...
													<input type="text" name="waitingCharges" value="<%=driverSal.getWAITING_CHARGES() %>" class="form-control input-sm" required onkeypress="CheckNumeric(event)"/>
													<%}else{%>
													You are not entered Salary,if you want to add Amount then please enter in Expected Amount
                                                   ...
                                                   <div class="col-md-1 col-xs-12 col-sm-12" align="center">
