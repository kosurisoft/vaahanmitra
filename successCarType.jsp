                                        ...
                                        <section class="example">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th colspan="2" style="text-align: center;background-color: #523f6d;color: #fff;">Car Type Successfully added...
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>                                                       
                                                         <tr>
                                                            <td>YOU WANT TO ADD ANOTHER CAR TYPE</td>
                                                           <td>
                                                            <div class="form-group"><div> <label>
                                                        <input class="radio squared"  name="squared-radios" onclick="location.href='carType.jsp'" type="radio">
                                                        <span>Yes</span>
                                                    </label> <label>
