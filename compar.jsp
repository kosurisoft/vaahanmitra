                ...
                <div class="container">
                    <div class="row">
                       ...
                       <div class="col-md-3 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner" style="min-height: 265px;">
                                            
                                        </div>
                                    <div class="col-lg-12" style="background: #efefef;">
                                        <ul>
                                        <li style="padding:5px 0px;font-weight:bold;">FUEL TYPE</li>
                                        <li style="padding:5px 0px;font-weight:bold;">COLOR</li>
                                        <li style="padding:5px 0px;font-weight:bold;">ENGIN NUMBER</li>
                                        <li style="padding:5px 0px;font-weight:bold;">CAR OWNER</li>
                                        <li style="padding:5px 0px;font-weight:bold;">KMS</li>
                                        </ul>
                                    </div>
                                    </div>
                        <div class="col-md-3 col-sm-6 col-xs-12 grid-item">
                                        <div class="grid-item-inner">
                                            <div class="grid-img-thumb">
                                                ...
                                                <a href="#"><img src="assets/images/C1.jpg" alt="1" class="img-responsive"></a>
                                            </div>
                            ...
                            <div class="col-lg-12" style="background: #efefef;">
                                        <ul>
                                        <li style="padding:5px 0px;">PETROL</li>
                                        <li style="padding:5px 0px;">RED</li>
                                        <li style="padding:5px 0px;">DM12345</li>
                                        <li style="padding:5px 0px;">kOSURI</li>
                                        <li style="padding:5px 0px;">20,000</li>
                                        </ul>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12 grid-item">
                            ...
                            <div class="col-lg-12" style="background: #efefef;">
                                       <ul>
                                        <li style="padding:5px 0px;">DEESEL</li>
                                        <li style="padding:5px 0px;">BLUE</li>
                                        <li style="padding:5px 0px;">DM12345</li>
                                        <li style="padding:5px 0px;">MAHESH KOSURI</li>
                                        <li style="padding:5px 0px;">40,000</li>
                                        </ul>
                                    </div>
                                    </div>
                            <div class="col-md-3 col-sm-6 col-xs-12 grid-item">
                            ...
                            <div class="col-lg-12" style="background: #efefef;">
                                       ...
                                       <ul>
                                        <li style="padding:5px 0px;">GAS</li>
                                        <li style="padding:5px 0px;">YELLOW</li>
                                        <li style="padding:5px 0px;">DM18885</li>
                                        <li style="padding:5px 0px;">MAHESH KOSURI</li>
                                        <li style="padding:5px 0px;">10,000</li>
                                        </ul>
                                    </div>
                                    </div>
