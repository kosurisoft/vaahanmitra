...
<%String message =(String)request.getAttribute("success"); %>
	<div class="main-wrapper">
		...
		<div  align="center"><h3>USED VEHICLE DEALER DASHBOARD</h3></div>
		</div>
						...
						<div class="card"
							...
							<div class="card-block" style="border-bottom: 3px solid #a3b745;">
								...
								<div class="table-responsive">
									<form action="./changeUsedVehicleDealerPasswordController" name="f1"
										method="post" onsubmit="return pass_validation()">
									<% if(message!=null){%>
              ...
              <%}else{}%> 
										...
										<div class="col-md-6 col-sm-12 " align="center">
											<button TYPE="submit"
															style="background-color: #a3b745;border-radius:10px; border: 1px solid #a3b745; align: center"
