				...
				<div class="col-md-12 col-xs-12 col-sm-12">
					<div class="card" id="individual1">
						<div class="card-block">
								...
								<form action="./SearchIOBikeRequester" method="post" align="center">
									<div class="col-md-12" id="one1">
										...
										<%
											...
											%>
									<input type="hidden" name="bikeRequester" value="bsc">
							...
							<input type="date" class="form-control" name="fdate" style="line-height:24px;"/>
							</div>
							
							<div class="col-sm-3">
							<label style="float: left;">From Date :</label>
							<input type="date" class="form-control" name="tdate" style="line-height:24px;"/>
							</div>
