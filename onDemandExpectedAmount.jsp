...
<title>Vaahanmitra | Driver Sal</title>
					...
					<div class="card" style="background: #fff; box-shadow: 0px 0px 2px 1px rgba(0,0,0,0.15);border-bottom: 3px solid #a3b745;">
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive">
									<form action="./InsertOnDemandExpectedAmount" method="post">
								...
								%>
									...
									<div class="col-md-12" style="background: #052963;color: #fff;text-align: center;font-weight: bolder;height:44px;margin-top:8px;padding: 10px;"><span style="margin-top:8px;">Expected Amount</span></div><br><br>
										...
										%>
										           ...
										           <label for="exampleInputEmail1">Expected Charges(per hour)</label>
													...
													<input type="text" name="expCharges" placeholder="Expected Charges" class="form-control input-sm" required onkeypress="CheckNumeric(event)"/>
													</div>
												</div>
												 ...
												 <div class="col-md-2 col-xs-12 col-sm-12">
										           ...
										           <label for="exampleInputEmail1">Waiting Charges</label>
													...
													<input type="text" name="waitingCharges" placeholder="Waiting Charges" class="form-control input-sm"  onkeypress="CheckNumeric(event)"/>
													</div>
												</div>
