					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive">
								...
								<div class="col-md-6">
									<label>
									 <input class="radio squared"
										name="squared-radios" onclick="location.href='individualUsedCar.jsp'"type="radio"> <span>Yes</span>
										</label>
										</div>
										<div class="col-md-6">YOU WANT TO SEARCH YOUR CAR</div>
										<div class="col-md-6 ">
											<label> <input class="radio squared" name="squared-radios" type="radio"
