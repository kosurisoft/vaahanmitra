						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xsm-12   res"  style="position: relative;top: 40px;">
							...
							<div class="col-md-1 col-xs-12"></div>
								...
								<div  class="auctionMainForm col-md-10 col-xs-12">
									...
									try
									{
										if(request.getAttribute("listedSpares")!=null)
										{
											spal=(ArrayList<String>)request.getAttribute("listedSpares");
										}
									...
									<form align="center" name="sellfrm" id="sellfrm"
										 action="./LoginControlller" method="post" autocomplete="off">
                                         ...
                                         <div align="center">
										  ...
										  <input type="hidden" name="listedSpares" value="spal">
										  <br>
