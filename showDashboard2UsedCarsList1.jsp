					...
					<div class="card"
						...
						<div class="card-block" style="border-bottom: 3px solid #a3b745;">
							...
							<div class="table-responsive">
								<form action="./showDashboard2UsedCarListController"
									method="GET">
									<div class="col-md-12" align="center"
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<c:forEach var="caral" items="${success}">
										<tr>
											...
											<td><a href="./updateUDUsedCar.jsp?id=${caral.GEN_CAR_ID}"><b>UPDATE</b></a></td>
								...
								<table>
									<tr>
										...
										<c:forEach begin="1" end="${noOfPages}" var="x">
											<td><a
													href="./showDashboard2UsedCarListController?page=${x}&brandid=<%=brandid%>&user_name=<%=user_name%>&carModel=<%=carModel%>&city=<%=city%>">&nbsp;${x}&nbsp;</a></td>
											</c:forEach>
									</tr>
									<%
										}
