...
<title>Vaahanmitra | Search Bikes</title>
<link href="assets/images/cg1.png" type="icon/img" rel="icon">
<link href="http://www.vaahanmitra.com/searchHServiceUsedBike.jsp" rel="canonical" />
<!-- Base Css -->
...
<script type="text/javascript">
	function callMe(myId) {
		var popup1 = window.open('./DisplayBikeImage.jsp?photo=' + myId,'mywindow','width=2000,height=1000,titlebar=0,status=no,toolbar=no,location=no,directories=no')
...
<!--                                     <input type="text" id="range" value="range" name="range" /> -->
						...
						<div class="sidber-box cats-facility">
							...
							<div class="facility">
									...
									<div class="select-filters" style="margin-bottom: 5px;">
										<select name="bikeBrand" id="sort-price"
					...
					<div class="col-sm-8 col-md-9">
						...
						<div class="hotel-list-content">
							...
							<div style="float: right" class="col-md-12 col-sm-12 col-xs-12"
								id="hiddenArea">
								<button type="button"
									style="padding: 7px 15px; float: right; margin-bottom: 5px; position: relative; right: 5px;"
							...
							<c:forEach var="bikeDetails" items="${bikeDetails}">
								<div class="row grid-margin">
										...
										<div class="grid-item-inner" id="mainDiv">
											<div class="grid-img-thumb">
												...
												<div style="height: 100%; width: 100%">
													<a onclick="callMe('${bikeDetails.BIKE_NUMBER}');" style="cursor: pointer;"> 
									...
									<div class="col-md-8 col-sm-6 col-xs-12 grid-item">
										...
										<section class="well"
											style="/* background-color: #efefef; height: 204px;  */padding-top: 10px;">
											<span
												style="color: #3c763d; font-size: 15px; padding-left: 20px; margin-top: 10px"><b><c:out
														value="${bikeDetails.BIKE_BRAND}"></c:out>&nbsp;&nbsp;&nbsp;<c:out
														value="${bikeDetails.BIKE_MODEL}"></c:out></b></span>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;
											<span
												style="color: #523f6d; font-size: 12px; padding-left: 20px; margin-top: 10px"><b><font
													color="red">BikeId:</font>&nbsp;&nbsp;<c:out
														value="${bikeDetails.GEN_BIKE_ID}"></c:out></b></span> <span
												style="float: right; margin-right: 10px;"><input
												type="checkbox" class="number" name="compare"
												value="${bikeDetails.GEN_BIKE_ID}" id="option<%=i %>" /></span> <span
												id="msg"
												style="color: red; float: right; position: relative; left: 48%; font-size: 12px; top: -16px;"></span>

											<span
												style="color: red; font-size: 12px; padding-left: 20px; position: relative; top: 10px;"><b>
													<br>PRICE&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<span
													style="color: #523f6d;">&#8377;&nbsp;&nbsp;&nbsp;<c:out
															value="${bikeDetails.OFFER_PRICE}"></c:out></span><br>
											</b></span> <span
												style="color: red; font-size: 12px; padding-left: 20px; position: relative; top: 10px;">
												<div style="margin-left:17px;"><b>Current
													Mileage&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<span
													style="color: #523f6d;"><c:out
															value="${bikeDetails.CURRENT_MILEAGE}"></c:out>&nbsp;&nbsp;&nbsp;km&nbsp;&nbsp;&nbsp;</span></div>
											</b></span> <br> <span
												style="color: red; font-size: 12px; padding-left: 20px; position: relative; top: 10px;"><b>Registered
													Year&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<span
													style="color: #523f6d;"><c:out
															value="${bikeDetails.REGISTERED_YEAR}"></c:out></span>
											</b></span> <br> <span
												style="color: red; font-size: 12px; padding-left: 20px; position: relative; top: 10px;"><b>Color&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<span
													style="color: #523f6d;"><c:out
															value="${bikeDetails.COLOR}"></c:out></span></b></span> <br> <span
												style="color: red; font-size: 12px; padding-left: 20px; position: relative; top: 10px;"><b>Registered
													State&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<span
													style="color: #523f6d;"><c:out
															value="${bikeDetails.REGISTERED_STATE}"></c:out></span>
											</b></span> <br>
...
// 			ArrayList<BikeEndUser> requesters = (ArrayList<BikeEndUser>)request.getAttribute("bikerequest");
...
<!-- 		</form> -->
	<% 	} else if(email!=null){
	%>  
		<a href="./SendBikeRequest?bid=${bikeDetails.GEN_BIKE_ID}&bb=${bikeDetails.BIKE_BRAND}" class="w3-button w3-green w3-large" style="float:right;margin-top:25px"><b style="color:black">SEND REQUEST</b></a>
	<%} else{%>
