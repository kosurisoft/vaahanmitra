...
<body>
 ...
 %> <%=str%>
							<div class="table-responsive">
								<div class="col-md-6">You want to add another Bike</div>
								<div class="col-md-6">
									<label> <input class="radio squared"
										name="squared-radios"
										onclick="location.href='addUDUsedBike.jsp'"
										type="radio"> <span>Yes</span>
									</label>
								</div>
								<div class="col-md-6">You want to add Bike photos</div>
								<div class="col-md-6 ">
									<label> <input class="radio squared"
										name="squared-radios"
										onclick="location.href='addUDBikePhotos.jsp'"
										type="radio"> <span>Yes</span>
									</label>
								</div>
								<div class="col-md-6">You want to search Bike</div>
								<div class="col-md-6 ">
									<label> <input class="radio squared"
										name="squared-radios"
										onclick="location.href='showDashboard2UsedBikeList.jsp'"
										type="radio"> <span>Yes</span>
									</label>
								</div>
