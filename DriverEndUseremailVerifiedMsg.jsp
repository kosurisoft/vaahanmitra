...
// 					System.out.println("email "+email+" name "+name1);
		...
		List<DriverEndUser> endUser=(ArrayList<DriverEndUser>)request.getAttribute("endUserList");
		List<String> driver=(ArrayList<String>)request.getAttribute("driverDetails");
		String message=(String)request.getAttribute("message");
		Iterator it=endUser.iterator();
		DriverEndUser dEndUser=null;
		while(it.hasNext()){
			
			dEndUser=(DriverEndUser)it.next();
		}
		%>
		<br>
		<br>
 ...
 <%} %>
			<table class="table">
				...
				<tbody>
					...
					<tr>
					 <th>Name</th>  <td><%=dEndUser.getNAME() %></td>
        <th>Appointment Date</th><td><%=dEndUser.getAPPOINTMENT_DATE()%></td>
         <th>Appointment Time</th><td><%=dEndUser.getAPPOINTMENT_TIME()%></td>
        <th>Driver Name</th> <td><%=driver.get(0)+" "+driver.get(1) %></td>
					</tr>
					<tr>
						  <th>Driver Email</th>  <td><%=driver.get(2) %></td>
        <th>Driver Mobile Number</th><td><%=driver.get(3) %></td>
         <th>Driver Id</th><td><%=driver.get(4) %></td>
